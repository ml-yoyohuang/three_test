...
if (process.env.NODE_ENV !== 'production') {
  ...
  require('!!raw-loader!~/html/special.pug');// eslint-disable-line
}
document.getElementById('link-special').classList.add('active');
...
const app = new Vue({
  ...
  methods: {
    ...
    loadObj(objUrl) {
      ...
      loader.load(objUrl, (o) => {
        // addBananaInScene(o, callback)
      });
    },
    createCubes() {
